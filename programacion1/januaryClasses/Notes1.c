/*#include <stdio.h> //Directivas (inclusion de archivos)
...
//Directivas (inclusion de archivos)
	...
	main (SOLO al principio o al final, pero no enmedio.)
...
int main(){
	...
	/*
		...
		Error semantico: Ejemplo: cuando no se declara una variable (error: 't' undeclared)
	*/
}
